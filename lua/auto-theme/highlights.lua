local util = require("auto-theme.util")
local M = {}
...
function M.setup()
	...
	hl.plugins.lsp = {
		...
		DiagnosticUnderlineError = { fmt = cfg.diagnostics.undercurl and "undercurl" or "underline", sp = c.error },
	...
	for group_name, group_settings in pairs(vim.g.auto_theme_config.highlights) do
		vim.api.nvim_command(
			string.format(
				"highlight %s %s %s %s %s",
				group_name,
